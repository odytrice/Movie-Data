...
let getMovieDetails id =
    ...
    {   
        ...
        Companies = [for c in details.ProductionCompanies -> c.Name]
        Poster = details.PosterPath
        Countries = [for c in details.ProductionCountries -> c.Name]
...
let getMovieCast id = 
    ...
    [for c in cast.Cast -> { Actor = c.Name; Character = c.Character}]
